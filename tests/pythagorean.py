...
def pythagorean(benchmark=False, dataDump=False):
    ...
    planet.setVelocity(Vector(np.array([0,0, 0.0], dtype='float64')))
    ...
    planet2.setVelocity(Vector(np.array([0,0, 0.0], dtype='float64')))
    ...
    planet3.setMass(5)
    planet3.setPosition(Vector(np.array([1, -1, 0.0], dtype='float64'))) 
    planet3.setVelocity(Vector(np.array([0,0, 0.0], dtype='float64')))
